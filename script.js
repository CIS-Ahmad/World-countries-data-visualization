...
function GetTotlatPeople() {
	...
	return countries_data.reduce((sum, c) => sum + c.population, 0);
}
...
function CalcluateTotalLang() {
	...
	return countries_data.reduce((acc, country) => {
...
document.addEventListener("DOMContentLoaded", () => {
	...
	getEleUsingID("CountriesNumber").textContent = countries_data.length;
